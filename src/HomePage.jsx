    ...
    try {
      ...
      if (response.status === 200) {
        ...
        sessionStorage.setItem(
          "parsedResumeData",
          JSON.stringify(parserResponse.data),
        );

        sessionStorage.setItem(
          "recommendedJobs",
          JSON.stringify(parserResponse.data.recommendedJobs),
        );

        const extractedSkills = parserResponse.data.extractedInfo.Skills;
        const formattedSkills = extractedSkills.map(
          (skill) => `Extracted: ${skill}`,
        );
        setSelectedSkills((prev) => [
          ...new Set([...prev, ...formattedSkills]),
        ]);
                      ...
                      ([subCategory, skills]) => (
                        <div key={subCategory} className="sub-category">
                          ...
                          >
                            {subCategory}
                            <span
                              className={`dropdown-arrow ${expandedCategories[`${category}-${subCategory}`] ? "expanded" : ""}`}
                            >
                              ▼
                            </span>
                          </button>
                          <div
                            className={`sub-skills-grid ${expandedCategories[`${category}-${subCategory}`] ? "expanded" : "collapsed"}`}
                          >
                            {skills.map((skill) => (
        ...
        >
                  ...
                  <div className="features-grid">
                    <div className="feature-card">
                      ...
                      <p>
                        ...
                        and skills to find the most relevant job opportunities.
                      </p>
                    </div>
                    <div className="feature-card">
                      <div className="feature-icon">🔍</div>
                      ...
                      <p>
                        Powerful filtering and search capabilities to find jobs
                ...
                <div className="features-carousel-slide">
                  <div className="features-grid">
                    <div className="feature-card">
                      ...
                      <p>
                        Personalized job suggestions based on your experience,
                    ...
                    <div className="feature-card">
                      ...
                      <p>
                        Data-driven insights into market trends, salary
          ...
          <footer className="footer">
            <div className="footer-content">
              ...
              <p>
                Join thousands of professionals who have already discovered
                their perfect job matches through our AI-powered platform. Start
                your journey today and unlock new opportunities that align with
